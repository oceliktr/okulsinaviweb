<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="OkulSinavi_CevrimiciSinavYonetim_OgrenciKayit, okulsinavi" enableEventValidation="false" %>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>
                                                                Aktif Dönem: <i data-toggle="tooltip" title="Yalnızca aktif döneme kayıt yapılır." class="fa fa-question-circle"></i>
                                                            </label>
