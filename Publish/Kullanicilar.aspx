<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="OkulSinavi.OkulSinaviKullanicilar, okulsinavi" enableEventValidation="false" %>
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="col-md-2">
                                            <asp:DropDownList runat="server" CssClass="form-control" ID="ddlYetki" ValidationGroup="form2">
                                                ...
                                                <asp:ListItem Value="Admin" Text="BT Formatör"></asp:ListItem>
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                        <ContentTemplate>
                                                                            ...
                                                                            <asp:CheckBox ID="cbAdmin" runat="server" Text="Bt Formatör" /><br />
                                                                            <asp:CheckBox ID="cbOkulYetkilisi" runat="server" Text="Okul - Kurum" />
                                                                        </ContentTemplate>
                                                                    </asp:UpdatePanel>
                                                                </div>
                                                            </div>
