<%@ page title="" language="C#" masterpagefile="MasterPage.master" autoeventwireup="true" inherits="OkulSinavi.admin_Ayarlar, okulsinavi" enableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        ...
        <small>Bu alanda sitenizin özel ve genel ayarlarını yapılandırabilirsiniz.</small>
            ...
            <ol class="breadcrumb">
                <li><a href="/Yonetim/Giris.aspx"><i class="fa fa-home"></i>Giriş</a></li>
