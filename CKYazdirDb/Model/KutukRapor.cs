...
namespace ODM.CKYazdirDb.Model
{
    ...
    public class KutukRapor
    {
        ...
        public KutukRapor(long opaqId, string ilceAdi, int kurumKodu, string kurumAdi, int ogrenciNo, string adi, string soyadi, int sinifi, string sube, string katilimDurumu, string sonuc)
        {
            OpaqId = opaqId;
            IlceAdi = ilceAdi;
            KurumKodu = kurumKodu;
