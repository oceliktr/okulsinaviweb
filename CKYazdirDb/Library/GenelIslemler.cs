...
namespace ODM.CKYazdirDb.Library
{
    public static class GenelIslemler
    {
        ...
        //public static string SubeIsmiKisalt(this string s) //sorun olmazsa silinecek
        //{
        //    if (string.IsNullOrEmpty(s)) return "";
        //    s = s.Replace(". Sınıf", "");
        //    s = s.Replace("Şubesi", "");
        //    s = s.Replace("-İmam Hatip", "");
        //    s = s.Replace("-İmam Hatip (Yabancı Dil Ağırlıklı Hazırlık Sınıfı)", "");
        //    s = s.Replace("-İmam Hatip (Yabancı Dil Ağırlıklı)", "");
        //    s = s.Replace("(Yabancı Dil Ağırlıklı)", "");
        //    s = s.Replace("(Yabancı Dil Ağırlıklı Hazırlık Sınıfı)", "");

        //    s = s.Replace("-Hafif Zihinsel", "");
        //    s = s.Replace("-Otistik Ağır", "");
        //    s = s.Replace("-Otistik Hafif", "");
        //    s = s.Replace("-Orta-Ağır Zihinsel", "");
