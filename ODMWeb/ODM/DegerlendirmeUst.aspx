<%@ Page Title="" Language="C#" MasterPageFile="~/ODM/MasterPage.master" AutoEventWireup="true" CodeFile="DegerlendirmeUst.aspx.cs" Inherits="ODM.OdmDegerlendirmeUst" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Üst Değerlendirici Ekranı</h1>
            <ol class="breadcrumb">
                <li><a href="Giris.aspx"><i class="fa fa-home"></i>Giriş</a></li>
                <li class="active">Üst Değerlendirici Ekranı</li>
            </ol>
        </section>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="box box-solid box-success">
                                        ...
                                        <div class="box-body">
                                            <div class="progress-group">
                                                <span class="progress-text">Size Gönderilen Cevap Kağıdı</span>
                                    ...
                                    <div class="box box-solid box-danger">
                                        <div class="box-header with-border">
                                            <h3 class="box-title">Değerlendirici Cevapları</h3>
                                        </div>
                                        <div class="box-body">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-sm-12 control-label">
                                                        <asp:Literal ID="ltrDegerlendiriciA" runat="server"></asp:Literal>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <asp:Literal ID="ltrDegerlendiriciB" runat="server"></asp:Literal>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="nav-tabs-custom">
                                                    <ul class="nav nav-tabs">
                                                        ...
                                                        <li class="" id="divKismiCevap" runat="server"><a href="#tab_2" data-toggle="tab" aria-expanded="false">Kısmi Cevap</a></li>
