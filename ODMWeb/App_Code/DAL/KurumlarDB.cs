...
using MySql.Data.MySqlClient;
    ...
    public class KurumlarDb
    {
        ...
        {
            const string sql = @"insert into kurumlar (KurumKodu,KurumAdi,IlceId,KurumTuru,Tur) values (?KurumKodu,?KurumAdi,?IlceId,?KurumTuru,?Tur)";
            MySqlParameter[] pars = 
            {
                new MySqlParameter("?KurumKodu", MySqlDbType.String),
        ...
        {
            const string sql = @"update kurumlar set KurumKodu=?KurumKodu,KurumAdi=?KurumAdi,IlceId=?IlceId,KurumTuru=?KurumTuru,Tur=?Tur where Id=?Id";
            MySqlParameter[] pars = 
            {
                new MySqlParameter("?KurumKodu", MySqlDbType.String),
                new MySqlParameter("?KurumAdi", MySqlDbType.String),
