...
public partial class LGSSoruBank_MasterPage : System.Web.UI.MasterPage
{
    ...
    {
        ODM.AdminUyarilar uyari = (AdminUyarilar)LoadControl("~/Kutuphaneler/Uyarilar.ascx");
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        //sidebar-mini wysihtml5-supported sidebar-collapse skin-green-light
        ...
        //öğretmen veya admin olmayanlar giremez
        if (!Yetki().Contains("Root") && !Yetki().Contains("Admin") && !Yetki().Contains("LgsYazari|"))
        {
            Response.Redirect("~/ODM/Cikis.aspx");
        }
    }
