<%@ Page Title="" Language="C#" MasterPageFile="~/LGSSoruBank/MasterPage.master" AutoEventWireup="true" CodeFile="Bilgilerim.aspx.cs" Inherits="LGSSoruBank_Bilgilerim" %>
                                                ...
                                                <div class="nav-tabs-custom">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="tab_1">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-4 control-label">Kurum Kodu</label>
                                                                <div class="col-sm-8">
                                                                    <asp:DropDownList runat="server" CssClass="form-control" ID="ddlKurumKodu" Enabled="False"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:Literal ID="ltrTcKimlik" runat="server"></asp:Literal></div>
                                                            </div>
                                                           <div class="form-group">
