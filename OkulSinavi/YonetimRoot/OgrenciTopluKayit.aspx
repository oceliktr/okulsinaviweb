<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="OgrenciTopluKayit.aspx.cs" Inherits="OkulSinavi_CevrimiciSinavYonetim_OgrenciTopluKayitRoot" %>
                ...
                <div class="modal-body mb-0 p-0">
                    ...
                    <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
                        ...
                        <video controls="controls" class="embed-responsive-item" autoplay>
                            <source src="/Yonetim/toplu_kayit.mp4" type="video/mp4" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script>
        ...
        function kontrolEt() {
            ...
            $.ajax({
                type: "POST",
                url: "/YonetimRoot/OgrenciTopluKayit.aspx/KayitKontrol",
                dataType: "json",
        ...
        function kaydet() {
            ...
            $.ajax({
                type: "POST",
                url: "/YonetimRoot/OgrenciTopluKayit.aspx/TopluKayit",
                dataType: "json",
