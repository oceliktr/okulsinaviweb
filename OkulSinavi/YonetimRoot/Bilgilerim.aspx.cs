...
public partial class OkulSinaviBilgilerimRoot : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Master.UyariBilgilendirme("Şifre değiştirilmeyecekse boş bırakınız. Düzenlenmeyen alanlar için sistem yönetici ile iletişime geçiniz.", phUyari);
        }
    }
