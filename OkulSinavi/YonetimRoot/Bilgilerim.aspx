<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Bilgilerim.aspx.cs" Inherits="OkulSinaviBilgilerimRoot" %>
                                ...
                                <div class="card-body">
                                    ...
                                    <asp:UpdatePanel runat="server"><ContentTemplate>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:DropDownList runat="server" CssClass="form-control" ID="ddlKurum"></asp:DropDownList>
                                            </div>
                                        </div>
