<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="OturumYonetim.aspx.cs" Inherits="Okul_SinaviYonetim_OturumYonetimRoot" %>
                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1 class="m-0 text-dark">
                            '<asp:Literal ID="ltrSinavAdi" runat="server"></asp:Literal>' Oturum Yönetim</h1>
                    </div>
                </div>
            </div>
        </div>
