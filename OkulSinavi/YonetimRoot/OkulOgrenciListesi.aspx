<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="OkulOgrenciListesi.aspx.cs" Inherits="Okul_SinaviYonetim_OkulOgrenciListesiRoot" %>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 pull-right">
                                                <a href="OgrenciKayit.aspx" class="btn btn-primary float-right"><i class="fa fa-plus-circle mr-2"></i>Yeni Öğrenci</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        $("#ContentPlaceHolder1_ddlSinif").on("change",
            function () {
                ...
                if (sinif === "") {
                    ...
                    $("#ogrenciler").load("/YonetimRoot/_OgrencilerOkul.aspx?Sinif=" +
                        sinif +"&kurumkodu="+kurumkodu);
                }
            });
        function Sil(id) {
            var sinif = $("#ContentPlaceHolder1_ddlSinif").val();
