...
{
    public partial class OkulSinaviKullanicilarRoot : System.Web.UI.Page
    {
        ...
        protected void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            string kurumkodu = Master.Yetki().Contains("Root") ? ddlKurum.SelectedValue : kInfo.KurumKodu;
            int ilce = Master.Yetki().Contains("Root") ? ddlIlce.SelectedValue.ToInt32() : kInfo.IlceId;
