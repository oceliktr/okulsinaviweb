...
public partial class OkulSinavi_CevrimiciSinavYonetim__Rapor_OkulOrtalamalari : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["SinavId"] != null)
            {
                if (Request.QueryString["SinavId"].IsInteger())
                {
                    ...
                    rptKayitlar.DataSource = veriDb.OkulPuanOrtalamalari(sinavId);
