...
public partial class OkulSinavi_CevrimiciSinavYonetim__Rapor_IlceOrtalamalari : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["SinavId"] != null)
            {
                if (Request.QueryString["SinavId"].IsInteger())
                {
                    ...
                    rptKayitlar.DataSource = veriDb.IlcePuanOrtalamalari(sinavId);
