...
public partial class OkulSinavi_CevrimiciSinavYonetim__Rapor_SinavaKatilmayanlar : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["SinavId"] != null)
            {
                if (Request.QueryString["SinavId"].IsInteger())
                {
                    ...
                    rptKayitlar.DataSource = veriDb.SinavaKatilmayanKurumlar(sinavId);
