...
sNext:"Sonraki",sPrevious:"Önceki"},sEmptyTable:"No data available in table",sInfo:"_START_ - _END_ kayıt. Toplam _TOTAL_ kayıt",sInfoEmpty:"0 - 0 kayıt. Toplam 0 kayıt",sInfoFiltered:"(_MAX_ kayıttan listelendi)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Sayfada _MENU_ kayıt",sLoadingRecords:"Yükleniyor...",sProcessing:"İşleniyor...",sSearch:"Ara:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Kayıt bulunamadı."},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
...
classes:{},build:"bs4/dt-1.10.21/af-2.3.5/b-1.6.3/b-colvis-1.6.3/b-flash-1.6.3/cr-1.5.2/fc-3.3.1/fh-3.1.7/kt-2.5.2",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],search:{},order:{}},_unique:0,fnVersionCheck:q.fnVersionCheck,iApiIndex:0,oJUIClasses:{},sVersion:q.version};f.extend(C,{afnFiltering:C.search,aTypes:C.type.detect,ofnSearch:C.type.search,oSort:C.type.order,afnSortData:C.order,aoFeatures:C.feature,oApi:C.internal,oStdClasses:C.classes,oPagination:C.pager});
