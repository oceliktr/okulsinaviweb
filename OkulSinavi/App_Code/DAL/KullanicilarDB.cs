...
using MySql.Data.MySqlClient;
    ...
    public DataTable OgretmenleriGetir(string yetki,int bransId)
        ...
        {
            const string sql = @"insert into kullanicilar (TcKimlik,Sifre,KurumKodu,Email,IlceId,Yetki,AdiSoyadi,Bransi,CepTlf,OncekiGiris,SonGiris) values (?TcKimlik,?Sifre,?KurumKodu,?Email,?IlceId,?Yetki,?AdiSoyadi,?Bransi,?CepTlf,?OncekiGiris,?SonGiris)";
            MySqlParameter[] pars = 
            {
                new MySqlParameter("?TcKimlik", MySqlDbType.String),
                new MySqlParameter("?Sifre", MySqlDbType.String),
