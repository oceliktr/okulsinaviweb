...
using MySql.Data.MySqlClient;
    ...
    public class CkKarneCevapTxtInfo
    {
        ...
        public CkKarneCevapTxtInfo(int id, string opaqId, int sinavId, string kitapcikTuru, int cevapTipi, int katilimDurumu, string cevaplar, int bransId)
        {
            Id = id;
            OpaqId = opaqId;
            SinavId = sinavId;
    ...
    public class CkKarneCevapTxtDB
    {
        ...
        public List<CkKarneCevapTxtInfo> KayitlariDizeGetir(int sinavId)
        {
            ...
            {
                karne.Add(new CkKarneCevapTxtInfo(Convert.ToInt32(k["Id"]), k["OpaqId"].ToString(),Convert.ToInt32(k["SinavId"]), k["KitapcikTuru"].ToString(), Convert.ToInt32(k["CevapTipi"]), Convert.ToInt32(k["KatilimDurumu"]), 
