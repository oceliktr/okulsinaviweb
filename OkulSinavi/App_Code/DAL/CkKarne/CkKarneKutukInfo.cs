    ...
    public class CkKarneKutukInfo
    {
        ...
        public CkKarneKutukInfo(int id, string opaqId, string ilceAdi, int kurumKodu, string kurumAdi, int ogrenciNo, string adi, string soyadi, int sinifi, string sube, int sinavId, string katilimDurumu, string kitapcikTuru, string cevaplar)
        {
            Id = id;
            OpaqId = opaqId;
            IlceAdi = ilceAdi;
