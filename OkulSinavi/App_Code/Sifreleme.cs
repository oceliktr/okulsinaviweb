...
public static class Sifreleme
{
    ...
    public static string hash1 = "T1R2C4O3D8E4S9M5A8N6CL7K7B8F4P9J5G10U6V11I6Y3H2Z0951243678AW1B2K12C23L0D6ME45AF5ZG5YH9EITJPKOLLMANZ";
    public static string hash = "159632147531257896312456987412365123456789887456321178965412365478925152454564568789784512341245789";
    public static string TcEncryp(this string tcKimlik)
    {
        ...
        for (int i = 0; i < tcKimlik.Length; i++)
        {
            if (i < 10)
            {
                string blog = tcKimlik.Substring(i, 2);
                sifre += hash[Convert.ToInt32(blog)];
            }
        }
