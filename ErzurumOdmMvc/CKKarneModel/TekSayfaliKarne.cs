...
namespace ErzurumOdmMvc.CKKarneModel
{
    ...
    public class TekSayfaliKarne
    {
        ...
        public void BirdenFazlaDersliPdfOlustur(Document doc, string sinavAdi, string dersAdi, CkKarneKutuk kutuk, string ogrenciCevabi, string dogruCvplar, List<CkKarneKazanimlar> kazanimlar, string katilimDurumu, string kitapcikTuru)
        {
        ...
        /// <param name="dogruCvplar"></param>
        /// <param name="kazanimlar"></param>
        public void PdfOlustur(Document doc, string sinavAdi, string dersAdi, CkKarneKutuk kutuk, string ogrenciCevabi, string dogruCvplar, List<CkKarneKazanimlar> kazanimlar, string katilimDurumu, string kitapcikTuru)
        {
            int soruSayisi = dogruCvplar.Length;
        ...
        /// </summary>
        public void PdfOlustur(Document doc, CkSinavAdi sinav, int sinif, string dersAdi, int column, string sonSatirBaslik, KarneModel karneModel)
        {
        ...
        public KarneModel KarneModeliOlusturIlce(CkSinavAdi sinav, string ilce, int sinif, string bransAdi, int brans, List<CkKarneKazanimlar> kazanimList, List<CkIlIlceOrtalamasi> basariYuzdesi)
        {
            ...
            foreach (var kazanim in kazanimList.Where(x => x.BransId == brans && x.Sinif == sinif))
            {
                ...
                CkIlIlceOrtalamasi ililceOrtalamasi = basariYuzdesi.FirstOrDefault(x => x.BransId == brans && x.Sinif == sinif && x.KazanimId == kazanim.KazanimId && x.Ilce == ilce);
        ...
        public KarneModel IlKarneModeliOlustur3(CkSinavAdi sinav, int sinif, string bransAdi, int brans, List<CkKarneKazanimlar> kazanimList, List<CkIlIlceOrtalamasi> basariYuzdesi)
        {
            int destekKazanimSayisi = 0;
            int telafiKazanimSayisi = 0;
            List<TableModel> model = new List<TableModel>();
            ...
            foreach (var kazanim in kazanimList.Where(x => x.BransId == brans && x.Sinif == sinif))
            {
                ...
                CkIlIlceOrtalamasi ililceOrtalamasi = basariYuzdesi.FirstOrDefault(x => x.BransId == brans && x.Sinif == sinif && x.KazanimId == kazanim.KazanimId);
                int ilBasariDurumu = ililceOrtalamasi.IlBasariYuzdesi;
        ...
        /// <returns></returns>
        public KarneModel KarneModeliOlusturOkul(string ilce, string kurumAdi, int sinif, int brans, CkSinavAdi sinav, string bransAdi, List<CkKarneKazanimlar> kazanimList, List<CkKarneSonuclari> karneSonucList, List<CkIlIlceOrtalamasi> basariYuzdesi)
        {
            int destekKazanimSayisi = 0;
            int telafiKazanimSayisi = 0;
            List<TableModel> model = new List<TableModel>();
        ...
        private static string RaporStr(string kurumAdi, int sinif, CkSinavAdi sinav, string bransAdi, List<string> eksikKazanimlar,
        ...
        /// <param name="basariYuzdesi"></param>
        /// <returns></returns>
        public KarneModel KarneModeliOlusturSube(string ilce, int kurumkodu, string kurumAdi, int sinif, string sube, int brans, CkSinavAdi sinav, string bransAdi, string okulAdi, List<CkKarneKazanimlar> kazanimList, List<CkKarneSonuclari> karneSonucList, List<CkIlIlceOrtalamasi> basariYuzdesi)
        {
            int destekKazanimSayisi = 0;
            int telafiKazanimSayisi = 0;
            List<TableModel> model = new List<TableModel>();
